...
また，図~\ref{fig:ntmresult}（a）の希釈木のエッジに付加された重みは，親ミキサーノードが\mout{子ミキサーノード，もしくは，子試薬液滴ノード（子ノード）}から受け取る液滴の数を表している．
...
\begin{figure}[tbp]
 \centering\includegraphics[scale=0.63]{img/NTMResult_jp.pdf}
